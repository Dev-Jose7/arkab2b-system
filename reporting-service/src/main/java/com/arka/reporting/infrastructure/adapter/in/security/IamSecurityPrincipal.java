package com.arka.reporting.infrastructure.adapter.in.security;
...
public final class IamSecurityPrincipal {
    ...
    public boolean isReportingAdmin() {
        return roles.contains("REPORTING_ADMIN")
                || roles.contains("ROLE_REPORTING_ADMIN")
                || roles.contains("ROLE_ARKA_ADMIN");
    }
