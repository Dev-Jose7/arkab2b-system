...
CREATE INDEX IF NOT EXISTS idx_carts_organization_org_user
    ON carts (organization_id, user_id, created_at DESC);
CREATE INDEX IF NOT EXISTS idx_carts_status
    ON carts (organization_id, status, updated_at DESC);
CREATE UNIQUE INDEX IF NOT EXISTS ux_carts_active_organization_org_user
    ON carts (organization_id, user_id)
...
CREATE INDEX IF NOT EXISTS idx_cart_items_organization_org
    ON cart_items (organization_id, sku);
...
CREATE UNIQUE INDEX IF NOT EXISTS ux_checkout_attempts_organization_correlation
    ON checkout_attempts (organization_id, checkout_correlation_id);
...
CREATE UNIQUE INDEX IF NOT EXISTS ux_purchase_orders_organization_order_number
    ON purchase_orders (organization_id, order_number);
CREATE UNIQUE INDEX IF NOT EXISTS ux_purchase_orders_organization_checkout_correlation
    ON purchase_orders (organization_id, checkout_correlation_id);
CREATE UNIQUE INDEX IF NOT EXISTS ux_purchase_orders_cart
    ON purchase_orders (cart_id);
CREATE INDEX IF NOT EXISTS idx_purchase_orders_organization_org_status_created
...
CREATE INDEX IF NOT EXISTS idx_order_lines_organization_sku
    ON order_lines (organization_id, sku);
...
CREATE INDEX IF NOT EXISTS idx_order_audits_order_created
    ON order_audits (organization_id, target_id, created_at DESC);
...
CREATE INDEX IF NOT EXISTS idx_idempotency_organization_created
