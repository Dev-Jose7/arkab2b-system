package com.arka.notification.infrastructure.adapter.out.security;
...
public class SecurityActorContextProviderAdapter implements ActorContextProviderPort {
    ...
    public SecurityActorContextProviderAdapter(
            ...
            @Value("${app.security.actor.fallback-actor-id:notification-scheduler}") String fallbackActorId,
