...
public interface ReactiveNotificationAuditRepository extends ReactiveCrudRepository<NotificationAuditRow, String> {
    ...
    @Query("""
            ...
            LIMIT 1
            """)
    Mono<NotificationAuditRow> findByIdempotency(String organizationId, String actionType, String idempotencyKey);
    ...
    @Query("""
            ...
            LIMIT :limit
            """)
    Flux<NotificationAuditRow> findByTarget(String organizationId, String targetType, String targetId, int offset, int limit);
