...
- controles de organization/rol y errores canonicos.
...
| IAM-E2E-006 | intento cross-organization en endpoint admin | actor organization A muta usuario organization B | rechazo `acceso_cruzado_detectado` + auditoria de seguridad | NFR-005, I-ACC-02, D-CROSS-01 |
...
| IAM-E2E-008 | consumo de `OrganizationSuspended` end-to-end | directory suspende organization -> IAM consume evento | usuarios del organization quedan bloqueados y se audita bloqueo | FR-009, NFR-005 |
