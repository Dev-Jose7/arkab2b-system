...
- `fixture_iam_role_assignment_cross_organization_invalid.yaml`
...
| IAM-UT-008 | asignacion cross-organization rechazada | usuario organization A + rol organization B | asignar rol | error `acceso_cruzado_detectado` | FR-009, NFR-005, I-ACC-02 |
...
| IAM-UT-011 | policy de organization obliga organizationId en mutaciones | comando mutante sin organization | validar policy | rechazo por aislamiento | NFR-005, D-CROSS-01 |
