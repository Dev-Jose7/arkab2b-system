...
| IAM-IT-008 | admin assign role permitido | rol/permiso + organization validos | 200 + `user_role_assignment` + `outbox_event(RoleAssigned)` | FR-009, RN-ACC-02 |
| IAM-IT-009 | admin assign role cross-organization | aislamiento organization | rechazo 403/409 + sin insercion en asignaciones | NFR-005, I-ACC-02, D-CROSS-01 |
...
| IAM-IT-014 | consumo `OrganizationSuspended` | politica de bloqueo por lote | usuarios del organization bloqueados + dedupe en `processed_event` | dominio IAM politicas, NFR-005 |
