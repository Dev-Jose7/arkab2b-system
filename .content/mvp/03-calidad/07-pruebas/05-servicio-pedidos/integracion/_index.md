...
- contexto de seguridad para `organization_user`, `arka_operator`, `arka_admin`, `system_scheduler`.
...
|---|---|---|---|---|
| ORD-IT-001 | `GET /cart` | recuperar carrito activo scoped por organization | response coherente con DB | FR-004 |
...
| ORD-IT-017 | listado de pedidos paginado | `GET /orders?page&size` | pagina, filtros y scope organization correctos | FR-004 |
...
| ORD-IT-026 | seguridad organization/ownership en mutaciones | actor organization A sobre recurso organization B | rechazo 403/409 + sin cambios | NFR-005, I-ACC-02 |
