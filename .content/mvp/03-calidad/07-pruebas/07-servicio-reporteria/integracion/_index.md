...
| REP-IT-004 | `GET /reports/artifacts/{reportId}` | metadata/descarga valida | 200 + ownership organization correcto | FR-007, NFR-005 |
...
| REP-IT-013 | duplicado de reporte semanal | `organization+week+type` existente | `409 reporte_duplicado` | FR-007 |
...
| REP-IT-028 | emision `WeeklyReportGenerated` | publicacion de reporte semanal | evento con `organization+week+type+locationRef` | FR-007 |
| REP-IT-029 | seguridad scope tecnico | token sin `reporting.ops` en endpoint interno | `403 forbidden_scope` + sin mutacion | NFR-005 |
| REP-IT-030 | aislamiento organization en consulta | actor organization A consulta organization B | rechazo `acceso_cruzado_detectado` | NFR-005, I-ACC-02 |
