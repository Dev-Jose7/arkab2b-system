...
| REP-UT-006 | prevenir duplicado semanal | existe `organization+week+type` previo | intentar nueva generacion | error `reporte_duplicado` | FR-007 |
...
| REP-UT-015 | aislamiento organization en consultas | actor organization A consulta organization B | validar `OrganizationIsolationPolicy` | error `acceso_cruzado_detectado` | NFR-005, I-ACC-02 |
| REP-UT-016 | comando mutante sin organization invalido | request m2m sin `organizationId` | validar contexto | rechazo por `D-CROSS-01` | NFR-005, D-CROSS-01 |
...
- En corrida de certificacion, no deben ocurrir mutaciones cross-organization ni sobre BC core transaccional.
