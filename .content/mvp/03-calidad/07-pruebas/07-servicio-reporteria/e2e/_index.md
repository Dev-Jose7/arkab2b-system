...
## Objetivo
Validar journeys criticos end-to-end de ingestion, consolidacion y consumo de reportes semanales con seguridad organization/rol, regionalizacion obligatoria y resiliencia operativa.
...
|---|---|---|---|---|
| REP-E2E-001 | consolidacion semanal de ventas | eventos `OrderCreated/Confirmed/Payment*` -> proyeccion -> consulta weekly | KPI de ventas y cobro consistentes por `organization+week` | FR-007, FR-010 |
...
| REP-E2E-013 | aislamiento organization en consultas | actor organization A consulta organization B | rechazo `acceso_cruzado_detectado` | NFR-005, I-ACC-02 |
...
- En corrida de certificacion, regionalizacion sin fallback global, seguridad organization/scope y dedupe deben verificarse de punta a punta.
