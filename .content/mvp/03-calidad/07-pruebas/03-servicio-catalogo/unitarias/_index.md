...
| CAT-UT-003 | SKU unico por organization para variante vendible | SKU ya usado en variante vendible | crear nueva variante | error `sku_no_unico` | FR-001, I-CAT-01, D-CAT-01 |
...
| CAT-UT-011 | policy de organization obliga organizationId en mutaciones | comando sin organization | validar policy | rechazo por aislamiento | NFR-005, D-CROSS-01 |
| CAT-UT-012 | acceso cruzado en recurso comercial | actor organization A sobre producto organization B | evaluar ownership | error `acceso_cruzado_detectado` | NFR-005, I-ACC-02 |
