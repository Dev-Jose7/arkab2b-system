...
public class DomainEventKafkaMapper implements DomainEventTopicPort {
    ...
    private final String accountActivatedTopic;
    ...
    public DomainEventKafkaMapper(
            ...
            @Value("${app.kafka.topics.account-activated:iam.account-activated.v1}") String accountActivatedTopic,
        ...
        this.accountActivatedTopic = accountActivatedTopic;
    ...
    public String topicFor(String eventType) {
        return switch (eventType) {
            ...
            case "AccountActivated" -> accountActivatedTopic;
