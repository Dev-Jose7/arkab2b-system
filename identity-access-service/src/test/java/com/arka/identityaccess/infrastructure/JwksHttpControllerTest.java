...
@TestPropertySource(properties = {
        "app.security.jwt.private-key-path=file:../platform/secrets/local/identity-access-private.pem",
        "app.security.jwt.public-key-path=file:../platform/secrets/local/identity-access-public.pem"
})
